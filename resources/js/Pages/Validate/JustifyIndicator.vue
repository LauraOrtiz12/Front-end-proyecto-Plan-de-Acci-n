...
<template>
    <AppLayout>
        ...
        <div class="max-w-7xl m-auto rounded-md shadow">
            <div class=" mx-4 py-8">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">{{
                                    traducirClave('name_indicator')
                                }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">
                                {{ $page.props.params.get_indicator.name_indicator }}
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">{{
                                    traducirClave('execution_goals')
                                }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">{{
                                    $page.props.params.execution_goals
                                }}
                            </td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">{{
                                    traducirClave('perspective')
                                }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">
                                {{ $page.props.params.get_indicator.perspective }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">{{
                                    traducirClave('name_perspective')
                                }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">
                                {{ $page.props.params.get_indicator.name_perspective }}
                            </td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">{{
                                    traducirClave('objective_strategy')
                                }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">
                                {{ $page.props.params.get_indicator.objective_strategy }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">{{
                                    traducirClave('name_strategy')
                                }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">
                                {{ $page.props.params.get_indicator.name_strategy }}
                            </td>
                        </tr>
                        <tr>
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">{{
                                    traducirClave('indicator_strategy')
                                }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">
                                {{ $page.props.params.get_indicator.indicator_strategy }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-1/4 whitespace-nowrap">
                                {{ traducirClave('name_indicator_strategy') }}
                            </td>
                            <td class="px-6 py-4 sm:w-1/2 md:w-3/4 whitespace-nowrap">
                                {{ $page.props.params.get_indicator.name_indicator_strategy }}
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div class=" bg-white rounded-lg shadow-lg p-6">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="observation_goal" id="observation_goal"
                        ...
                        <div class="mb-4">
                            <label for="justification_goals_budget" class="block mb-2">Justificación de Meta
                                Propuesta</label>
                            <input type="text" name="justification_goals_budget" id="justification_goals_budget"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="mb-4">
                                ...
                                <input type="date" name="initial_date" id="initial_date"
                                       class="w-full px-3 py-2 border rounded-md" v-model="form.initial_date">
                                <div class="error-message bg-red-500 text-white rounded p-1 text-sm"
                                     v-if="form.errors.initial_date">{{ form.errors.initial_date }}
                                </div>
                            </div>
                            <div class="mb-4">
                                <label for="final_date" class="block mb-2">Fecha Fin</label>
                                <input type="date" name="final_date" id="final_date"
                                       class="w-full px-3 py-2 border rounded-md" v-model="form.final_date">
                                <div class="error-message bg-red-500 text-white rounded p-1 text-sm"
                                     v-if="form.errors.final_date">{{ form.errors.final_date }}
                                </div>
                            </div>
                        </div>
                        <div class="mb-4">
                            <label for="physical_resource" class="block mb-2">Recurso Físico</label>
                            <input type="text" name="physical_resource" id="physical_resource"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="technical_resource" id="technical_resource"
                                   class="w-full px-3 py-2 border rounded-md" v-model="form.technical_resource">
                            <div class="error-message bg-red-500 text-white rounded p-1 text-sm"
                                 v-if="form.errors.technical_resource">{{ form.errors.technical_resource }}
                            </div>
                        </div>
                        <div class="mb-6">
                            <label for="human_resource" class="block mb-2">Recurso Humano</label>
                            <input type="text" name="human_resource" id="human_resource"
                                   class="w-full px-3 py-2 border rounded-md" v-model="form.human_resource">
                            <div class="error-message bg-red-500 text-white rounded p-1 text-sm"
                                 v-if="form.errors.human_resource">{{ form.errors.human_resource }}
                            </div>
                        </div>
