                        ...
                        <button @click="closeFollowUp(month)" id="closeButton"
                            ...
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                      d="M12 8v4m0 4h.01m-6.938 4h13.856C18.37 21 20 19.371 20 17.257V6.743C20 4.63 18.37 3 16.258 3H7.743C5.63 3 4 4.63 4 6.743v10.514C4 19.371 5.63 21 7.743 21z"></path>
                            </svg>
                            Cerrar Seguimiento
                        </button>
                    </div>
