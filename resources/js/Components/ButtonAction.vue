...
<template>
    <div class="grid grid-cols-2 gap-2">
        <button @click="onEdit(this.params.value)" class="flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
        ...
        <button @click="gotoEstateIndicator(this.params.value)" class="flex items-center justify-center bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
